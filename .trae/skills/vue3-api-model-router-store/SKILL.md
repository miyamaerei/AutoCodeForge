...
description: "Checklist skill for Vue 3 module scaffolding. Invoke when creating api/model/router/store with fixed stack and enforced module-first folder structure."
---
...
- [.trae/instructions/modules-naming-exports.instructions.md](../../instructions/modules-naming-exports.instructions.md)
