...
description: 'Triage and document policy conflicts between implementation and audit rules. Use for conflict detection, evidence capture, impact analysis, and SPEC_CHANGE_REQUEST drafting.'
argument-hint: 'Describe conflict symptom, affected files, and expected rule outcome.'
---
